  ...
  for (let list in data) {
    ...
    eachCard.addEventListener("click", () => {
      ...
      modalTemplate(
        ...
        data[list].img,
        data[list].tags,
        data[list].info.attack,
        data[list].info.defense,
        data[list].info.magic,
        data[list].info.difficulty
      );
    });
  }
}
...
document
  .getElementById("as")
  .addEventListener("click", () => makeCalc(lolArchive, "Assassin"));
document
  .getElementById("ma")
  .addEventListener("click", () => makeCalc(lolArchive, "Mage"));
document
  .getElementById("lu")
  .addEventListener("click", () => makeCalc(lolArchive, "Fighter"));
document
  .getElementById("at")
  .addEventListener("click", () => makeCalc(lolArchive, "Marksman"));
document
  .getElementById("su")
  .addEventListener("click", () => makeCalc(lolArchive, "Support"));
document
  .getElementById("ta")
  .addEventListener("click", () => makeCalc(lolArchive, "Tank"));
...
function makeCalc(data, type) {
  ...
  document.getElementById(
    "calc"
  ).innerHTML = `Você sabia que ${showCalc} % dos Champions são ${type}?
  `;
